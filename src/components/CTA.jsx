...
import ctaAvif from '../assets/cta.avif'

const CTA = () => {
    return (
        <section id="cta" >
            <div className="container ">
                <div className="relative bg-gray-120 py-9 px-6 md:px-16 md:pr-34 md:py-12 rounded-xl md:flex md:justify-between    md:gap-21 md:items-center  mx-auto mb-11 md:mb-0">
                    <div className="relative flex flex-col gap-3 md:gap-4 max-w-46 md:max-w-none md:min-w-60.5  z-10">
                        <h2 className="hero-cta">Immerse yourself in your music</h2>
                        <p className="paragraph-cta">Buy Now, up to 40% off.</p>

                        <div role="button" tabIndex={0} className="flex items-center gap-3 py-4 px-6 rounded-lg w-fit button bg-black-120">
                            ...
                            <p className="text-[15px] text-white ">Buy now</p>
                        </div>
                    </div>

                   
                    <picture>
                        <source srcSet={ctaAvif} type="image/avif" />
                         <img  src={ctaImage} alt="image cta" width={300} height={206} className="image-cta " />
                    </picture>
                </div>
            </div>
        </section>
