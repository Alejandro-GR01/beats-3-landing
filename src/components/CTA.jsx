    ...
    return (
        <section id="cta" >
            <div className="container ">
                <div className="relative bg-gray-120 py-9 px-6 md:py-12 rounded-xl md:flex md:justify-center md:gap-21 md:items-center  max-w-242 mx-auto mb-11 md:mb-0">
                    <div className="shrink-0 relative flex flex-col gap-3 md:gap-4 max-w-46 md:max-w-60 z-10">
                        <h2 className="hero-cta">Immerse yourself in your music</h2>
                        <p className="paragraph-cta">Buy Now, up to 40% off.</p>

                        <div className="flex items-center gap-3 py-4 px-6 rounded-lg w-fit button bg-black-120">
