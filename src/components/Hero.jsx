      ...
      <div className="container relative ">
        <div className="relative flex flex-col gap-10 justify-center items-start  md:pl-[38svw] pt-46 md:pt-32  z-10 ">
          ...
          <div className="flex flex-col gap-5 max-w-md  md:max-w-sm  ">
            ...
            <p className='paragraph'>Enjoy award-winning Beats sound with wireless listening freedom and a sleek, streamlined design with comfortable padded earphones, delivering first-rate playback.</p>
          </div>

          <div role='button' tabIndex={0} className='button flex items-center gap-3 bg-gray-120 px-5 py-3 rounded-lg text-white'>
            ...
            <p className='text-[15px]! text-white! '>Add to Bag</p>
            <p className='text-xl! font-bold!'>N399K</p>
          </div>
